...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 29, 2024 at 10:56 AM
...
INSERT INTO `log_in` (`id_usuario`, `email`, `password`, `role`) VALUES
(1, 'webadmin@gmail.com', 'admin', 'admin'),
(2, 'webuser', 'webuser', 'default');
...
--
ALTER TABLE `calzado`
  MODIFY `id_calzado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
